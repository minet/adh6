...
export * from './miniRouter.service';
import { MiniRouterService } from './miniRouter.service';
export * from './misc.service';
import { MiscService } from './misc.service';
export * from './naina.service';
import { NainaService } from './naina.service';
...
export const APIS = [AuthenticationService, CharterService, DeviceService, MailinglistService, MemberService, MembershipService, MiniRouterService, MiscService, NainaService, PortService, RoomService, RoomMembersService, SwitchService, TransactionService, TreasuryService, VlanService];
