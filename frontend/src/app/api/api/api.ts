...
export const APIS = [AuthenticationService, CharterService, DeviceService, MailinglistService, MemberService, MembershipService, MiscService, NainaService, PortService, RoomService, RoomMembersService, SwitchService, TransactionService, TreasuryService, VlanService];
