...
class TestGetFromNumber:
    def test_happy_path(self, sample_vlan: Vlan, mock_vlan_repository: VlanRepository, vlan_manager: VlanManager):
    ...
    def test_vlan_not_found(self, sample_vlan: Vlan, mock_vlan_repository: VlanRepository, vlan_manager: VlanManager):
