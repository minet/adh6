...
class AbstractMember(object):
    ...
    def __init__(self, id=None, username=None, association_mode=None, comment=None, departure_date=None, email=None, first_name=None, last_name=None, room=None):  # noqa: E501
