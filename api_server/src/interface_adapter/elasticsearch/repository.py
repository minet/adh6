...
class ElasticSearchRepository(LogsRepository):
    ...
    def get_logs(self, ctx, limit=DEFAULT_LIMIT, username=None, devices=None, dhcp=False):
        """
                    ...
                    "constant_score": {
                        "filter": {
                            "bool": {
                                ...
                                "minimum_should_match": 1,
                                "must_not": {
                                    "match": {"tags": "encrypted"}
                                },
                            },
                        },
                    },
                },
                "_source": ["@timestamp", "message", "program", "src_mac"],  # discard any other field than timestamp & message
                "size": limit,
                "from": 0,
            }
