...
class SwitchSNMPNetworkManager(SwitchNetworkManager):
    ...
    def get_oid_switch_ipand_community_from_port_id(self, port_id) -> tuple[str, str, str]:
        ...
        switch = self.switch_repository.get_by_id(object_id=port.switch_obj)  # type: ignore  # TODO: typing
        community = self.switch_repository.get_community(switch_id=port.switch_obj)  # type: ignore  # TODO: typing
