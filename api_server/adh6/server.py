...
def get_obj_graph():
    ...
    _global = (
        ...
        + [
            ...
            NotificationTemplateSQLRepository,
        ]
    ...
    _base_interfaces = [abc.ABC, CRUDManager, CRUDRepository, DefaultHandler, object]
    ...
    _class_name_to_abstract = {cls.__name__: get_base_class(cls) for cls in _global}
