...
class DeviceBody(BaseModel):
    ...
    member: Optional[StrictInt] = Field(description="The id of the owner of the device")
    __properties: ClassVar[List[str]] = ["connectionType", "mac", "member"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceBody from a dict"""
        if obj is None:
            return None
