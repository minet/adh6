...
class ApiKeysPostRequest(BaseModel):
    ...
    login: StrictStr
    roles: List[Role]
    __properties: ClassVar[List[str]] = ["login", "roles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiKeysPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiKeysPostRequest from a dict"""
        if obj is None:
            return None
