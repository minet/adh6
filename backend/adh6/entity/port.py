...
class Port(BaseModel):
    ...
    port_number: Optional[StrictStr] = Field(description="The friendly (Cisco) number of this port", alias="portNumber")
    oid: StrictStr = Field(description="The oid of this port for SNMP access")
