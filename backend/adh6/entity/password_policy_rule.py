...
class PasswordPolicyRule(BaseModel):
    ...
    PasswordPolicyRule
    """ # noqa: E501
    name: StrictStr = Field(description="Keycloak password-policy provider identifier")
    value: StrictStr = Field(description="Configured provider value, or an empty string for a value-less rule")
