...
class AbstractPort(BaseModel):
    """
    AbstractPort
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of this port")
    port_number: Optional[StrictStr] = Field(default=None, description="The friendly (Cisco) number of this port", alias="portNumber")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractPort from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractPort from a dict"""
        if obj is None:
            return None
