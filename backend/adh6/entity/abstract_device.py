...
class AbstractDevice(BaseModel):
    ...
    connection_type: Optional[StrictStr] = Field(default=None, description="The connection type of this device", alias="connectionType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractDevice from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractDevice from a dict"""
        if obj is None:
            return None
