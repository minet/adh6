...
class Profile200Response(BaseModel):
    """
    Profile200Response
    """ # noqa: E501
    member: Optional[Member] = None
    roles: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["member", "roles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Profile200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Profile200Response from a dict"""
        if obj is None:
            return None
