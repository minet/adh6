...
class AbstractMembership(BaseModel):
    ...
    AbstractMembership
    """ # noqa: E501
    uuid: Optional[StrictStr] = Field(default=None, description="The UUID associated with this membership request")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractMembership from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractMembership from a dict"""
        if obj is None:
            return None
