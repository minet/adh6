...
class RoleMapping(BaseModel):
    ...
    identifier: Optional[StrictStr] = Field(default=None, description="The login of the user link to the api key")
    __properties: ClassVar[List[str]] = ["id", "role", "authentication", "identifier"]
    ...
    def authentication_validate_enum(cls, value):
        ...
        if value not in set(['oidc', 'api_key', 'user']):
            raise ValueError("must be one of enum values ('oidc', 'api_key', 'user')")
        return value
