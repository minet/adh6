...
class AbstractRoom(Model):
    ...
    def __init__(self, id=None, description=None, room_number=None, vlan=None):  # noqa: E501
        """AbstractRoom - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'AbstractRoom':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The AbstractRoom of this AbstractRoom.  # noqa: E501
        :rtype: AbstractRoom
        """
    ...
    @property
    def id(self) -> int:
        """Gets the id of this AbstractRoom.

        The unique identifier of this room  # noqa: E501

        :return: The id of this AbstractRoom.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id: int):
        ...
        :param id: The id of this AbstractRoom.
        :type id: int
        """
    ...
    def description(self) -> str:
        """Gets the description of this AbstractRoom.

        The friendly description of this room  # noqa: E501

        :return: The description of this AbstractRoom.
        :rtype: str
        """
    ...
    def description(self, description: str):
        ...
        :param description: The description of this AbstractRoom.
        :type description: str
        """
    ...
    def room_number(self) -> int:
        """Gets the room_number of this AbstractRoom.

        The room number according to the Maisel  # noqa: E501

        :return: The room_number of this AbstractRoom.
        :rtype: int
        """
    ...
    def room_number(self, room_number: int):
        ...
        :param room_number: The room_number of this AbstractRoom.
        :type room_number: int
        """
    ...
    @property
    def vlan(self) -> int:
        """Gets the vlan of this AbstractRoom.

        The main vlan number assigned to this room  # noqa: E501

        :return: The vlan of this AbstractRoom.
        :rtype: int
        """
        return self._vlan
    ...
    def vlan(self, vlan: int):
        ...
        :param vlan: The vlan of this AbstractRoom.
        :type vlan: int
        """
