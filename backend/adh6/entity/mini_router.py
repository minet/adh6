...
class MiniRouter(BaseModel):
    """
    MiniRouter
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The unique identifier of this mini-router")
    hardware_mac: StrictStr = Field(description="The factory MAC address of the mini-router", alias="hardwareMac")
    ...
    model: StrictStr = Field(description="The hardware model")
    config_state: StrictStr = Field(description="Whether the MiNET configuration is applied", alias="configState")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MiniRouter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MiniRouter from a dict"""
        if obj is None:
            return None
