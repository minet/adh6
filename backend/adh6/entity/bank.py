...
class Bank(BaseModel):
    ...
    Bank
    """ # noqa: E501
    expected_cav: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="the expected balance of MiNET's CAV accunt", alias="expectedCav")
    __properties: ClassVar[List[str]] = ["expectedCav"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "expectedCav": obj.get("expectedCav")
        })
        return _obj
