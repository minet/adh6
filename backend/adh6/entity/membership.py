...
class Membership(Model):
    ...
    @property
    def uuid(self) -> str:
        """Gets the uuid of this Membership.

        The UUID associated with this membership request  # noqa: E501

        :return: The uuid of this Membership.
        :rtype: str
        """
        return self._uuid
    ...
    def uuid(self, uuid: str):
        ...
        :param uuid: The uuid of this Membership.
        :type uuid: str
        """
        if uuid is None:
    ...
    def duration(self) -> int:
        """Gets the duration of this Membership.

        The requested duration (in months) for this membership  # noqa: E501

        :return: The duration of this Membership.
        :rtype: int
        """
    ...
    def duration(self, duration: int):
        ...
        :param duration: The duration of this Membership.
        :type duration: int
        """
    ...
    def has_room(self) -> bool:
        """Gets the has_room of this Membership.

        if the Member ask for a room or not  # noqa: E501

        :return: The has_room of this Membership.
        :rtype: bool
        """
    ...
    def has_room(self, has_room: bool):
        ...
        :param has_room: The has_room of this Membership.
        :type has_room: bool
        """
        if has_room is None:
            raise ValueError("Invalid value for `has_room`, must not be `None`")  # noqa: E501

        self._has_room = has_room

    @property
    def first_time(self) -> bool:
        """Gets the first_time of this Membership.

        Whether this is the first membership request ever for this member  # noqa: E501

        :return: The first_time of this Membership.
        :rtype: bool
        """
    ...
    def first_time(self, first_time: bool):
        ...
        :param first_time: The first_time of this Membership.
        :type first_time: bool
        """
    ...
    def payment_method(self) -> int:
        """Gets the payment_method of this Membership.

        The payment method id to be used for the transaction  # noqa: E501

        :return: The payment_method of this Membership.
        :rtype: int
        """
    ...
    def payment_method(self, payment_method: int):
        ...
        :param payment_method: The payment_method of this Membership.
        :type payment_method: int
        """
    ...
    def account(self, account: int):
        ...
        :param account: The account of this Membership.
        :type account: int
        """
