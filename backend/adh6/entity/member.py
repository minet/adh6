...
class Member(BaseModel):
    ...
    Member
    """ # noqa: E501
    id: StrictInt = Field(description="The unique identifier of this member")
    username: StrictStr = Field(description="The username of this member")
    first_name: StrictStr = Field(description="The first name of this member", alias="firstName")
    last_name: StrictStr = Field(description="The last name of this member", alias="lastName")
    email: StrictStr = Field(description="The email address of this member")
