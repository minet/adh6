...
@Component({
  selector: 'app-portailfoyer',
  templateUrl: './portailfoyer.component.html',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./portailfoyer.component.css']
})
export class PortailfoyerComponent implements OnInit {
  ...
  onSubmit($event) {
    ...
    form.appendChild(PortailfoyerComponent.createHiddenElement('confirm', '1'));
