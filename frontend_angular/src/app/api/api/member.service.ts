...
export class MemberService {
     ...
     * @param criticalError flag to set whether an error on this request should me considered critical for the application flow
     */
    public memberIdGet(id: number, only?: Array<string>, observe?: 'body', reportProgress?: boolean, criticalError?: boolean): Observable<AbstractMember>;
    public memberIdGet(id: number, only?: Array<string>, observe?: 'response', reportProgress?: boolean, criticalError?: boolean): Observable<HttpResponse<AbstractMember>>;
    public memberIdGet(id: number, only?: Array<string>, observe?: 'events', reportProgress?: boolean, criticalError?: boolean): Observable<HttpEvent<AbstractMember>>;
    public memberIdGet(id: number, only?: Array<string>, observe: any = 'body', reportProgress: boolean = false, criticalError: boolean = true ): Observable<any> {
        ...
        headers = headers.set('X-Critical-Error', ''+criticalError);
        return this.httpClient.request<AbstractMember>('get',`${this.basePath}/member/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
