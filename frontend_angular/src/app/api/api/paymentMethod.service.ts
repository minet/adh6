...
import { PaymentMethodPatchRequest } from '..';
...
export class PaymentMethodService {
    ...
    public paymentMethodPaymentMethodIdPatch(body: PaymentMethodPatchRequest, paymentMethodId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('patch',`${this.basePath}/payment_method/${encodeURIComponent(String(paymentMethodId))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public paymentMethodPost(body: PaymentMethod, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/payment_method/`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
