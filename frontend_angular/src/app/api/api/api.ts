...
export const APIS = [AccountService, AccountTypeService, BugReportService, CaisseService, DefaultService, DeviceService, MemberService, MembershipService, PaymentMethodService, PortService, ProductService, RoomService, SwitchService, TemporaryAccountService, TransactionService];
