...
export class AccountService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public accountGet(limit?: number, offset?: number, terms?: string, filter?: AbstractAccount, observe?: 'body', reportProgress?: boolean): Observable<Array<Account>>;
    public accountGet(limit?: number, offset?: number, terms?: string, filter?: AbstractAccount, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Account>>>;
    public accountGet(limit?: number, offset?: number, terms?: string, filter?: AbstractAccount, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Account>>>;
    public accountGet(limit?: number, offset?: number, terms?: string, filter?: AbstractAccount, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
