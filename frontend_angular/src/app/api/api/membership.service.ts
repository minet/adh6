...
export class MembershipService {
     ...
     */
    public getLatestMembership(id: number, only?: Array<string>, observe?: 'body', reportProgress?: boolean, criticalError?: boolean): Observable<AbstractMembership>;
    public getLatestMembership(id: number, only?: Array<string>, observe?: 'response', reportProgress?: boolean, criticalError?: boolean): Observable<HttpResponse<AbstractMembership>>;
    public getLatestMembership(id: number, only?: Array<string>, observe?: 'events', reportProgress?: boolean, criticalError?: boolean): Observable<HttpEvent<AbstractMembership>>;
    public getLatestMembership(id: number, only?: Array<string>, observe: any = 'body', reportProgress: boolean = false, criticalError: boolean = true ): Observable<any> {
        ...
        return this.httpClient.request<AbstractMembership>('get',`${this.basePath}/member/${encodeURIComponent(String(id))}/membership/`,
            {
     ...
     * @param criticalError flag to set whether an error on this request should me considered critical for the application flow
     */
    public membershipSearch(limit?: number, offset?: number, terms?: string, filter?: any, only?: Array<string>, observe?: 'body', reportProgress?: boolean, criticalError?: boolean): Observable<Array<AbstractMembership>>;
    public membershipSearch(limit?: number, offset?: number, terms?: string, filter?: any, only?: Array<string>, observe?: 'response', reportProgress?: boolean, criticalError?: boolean): Observable<HttpResponse<Array<AbstractMembership>>>;
    public membershipSearch(limit?: number, offset?: number, terms?: string, filter?: any, only?: Array<string>, observe?: 'events', reportProgress?: boolean, criticalError?: boolean): Observable<HttpEvent<Array<AbstractMembership>>>;
    public membershipSearch(limit?: number, offset?: number, terms?: string, filter?: any, only?: Array<string>, observe: any = 'body', reportProgress: boolean = false, criticalError: boolean = true ): Observable<any> {
        ...
        headers = headers.set('X-Critical-Error', ''+criticalError);
        return this.httpClient.request<Array<AbstractMembership>>('get',`${this.basePath}/member/membership/`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
