...
export class TransactionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public transactionPost(body: Transaction, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public transactionPost(body: Transaction, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public transactionPost(body: Transaction, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
     ...
     * Update/create
     *
     * @param body New values for the transaction, only the attachments can be modified
     * @param transactionId The unique identifier of the transaction that needs to be updated
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public transactionTransactionIdPut(body: Transaction, transactionId: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public transactionTransactionIdPut(body: Transaction, transactionId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public transactionTransactionIdPut(body: Transaction, transactionId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public transactionTransactionIdPut(body: Transaction, transactionId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
