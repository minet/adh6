...
export class TransactionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public transactionGet(limit?: number, offset?: number, terms?: string, filter?: AbstractTransaction, observe?: 'body', reportProgress?: boolean): Observable<Array<Transaction>>;
    public transactionGet(limit?: number, offset?: number, terms?: string, filter?: AbstractTransaction, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Transaction>>>;
    public transactionGet(limit?: number, offset?: number, terms?: string, filter?: AbstractTransaction, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Transaction>>>;
    public transactionGet(limit?: number, offset?: number, terms?: string, filter?: AbstractTransaction, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
